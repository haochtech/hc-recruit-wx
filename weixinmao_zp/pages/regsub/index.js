...
Page({
    ...
    savepubinfo: function(a) {
        var e = this, t = wx.getStorageSync("userInfo"), o = a.detail.value.name, n = a.detail.value.tel, s = a.detail.value.companyname;
        e.data.date, e.data.jobdate;
        if ("" != o) if ("" != e.data.date) if ("" != e.data.jobdate) if ("" != s) if ("" != n) {
            var i = {
                sessionid: t.sessionid,
                uid: t.memberInfo.uid,
                name: o,
                date: e.data.date,
                jobdate: e.data.jobdate,
                companyname: s,
                tel: n
            };
            app.util.request({
