...
Page((_defineProperty(_Page = {
  ...
  cancel_login: function (e) {
    ...
    savepubinfo: function(e) {
        ...
        var a, n = e.detail.value.jobtitle, s = e.detail.value.name, d = t.data.sex, o = this.data.birthdayname, r = t.data.educationname, l = t.data.expressname, u = e.detail.value.address, c = e.detail.value.email, h = e.detail.value.tel, p = t.data.currentstatusname, f = t.data.worktypename, x = this.data.jobcateid, m = this.data.moneyname, w = this.data.areaid, g = e.detail.value.content;
        if (wx.getStorageSync("tid") && wx.getStorageSync("tid"), wx.getStorageSync("shareid") && wx.getStorageSync("shareid"), 
        "" != n) if (0 != s) if ("" != o) if ("" != r) if ("" != l) if ("" != u) if ("" != c) if ("" != h) if ("" != p) if ("" != f) if (0 != x) if ("" != m) if (0 != w) if ("" != g) {
            ...
            if (y.length < 2) wx.showModal({
                ...
                _defineProperty(a, "jobcateid", x), _defineProperty(a, "money", m), _defineProperty(a, "areaid", w), 
